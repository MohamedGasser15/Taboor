...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Persist the sidebar state so it survives page refreshes.
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar transition-[opacity] duration-300 group-data-[state=collapsed]:opacity-0 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
