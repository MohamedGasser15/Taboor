...
function ToastIcon({ type }: { type: string | undefined }) {
  ...
  if (type === 'success') {
    icon = <CircleCheckIcon className="text-teal" aria-hidden="true" />
  }
  ...
  if (type === 'warning') {
    icon = <TriangleAlertIcon className="text-amber" aria-hidden="true" />
  }
  ...
  if (type === 'loading') {
    icon = <Loader2Icon className="animate-spin text-teal" aria-hidden="true" />
  }
