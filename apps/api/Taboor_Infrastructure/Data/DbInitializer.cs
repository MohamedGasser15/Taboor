...
namespace Taboor_Infrastructure.DB
{
    ...
    public static class DbInitializer
    {
        ...
        {
            string[] roles = { SD.Admin, SD.Customer, SD.User };
        ...
        private static async Task SeedUsersAsync(UserManager<ApplicationUser> userManager)
        {
            ...
            {
                ("admin@taboor.com", "Admin@123", "Taboor Admin", "01000000001", SD.Admin),
                ("customer@taboor.com", "Customer@123", "Taboor Customer", "01000000002", SD.Customer),
                ("user@taboor.com", "User@123", "Taboor User", "01000000003", SD.User)
            };
